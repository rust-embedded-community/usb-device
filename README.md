...
pre-existing ones provided by other crates) and a UsbCore device drives to implement the USB device.
...
The UsbCore trait is intended to be implemented by device-specific crates to provide a driver for
